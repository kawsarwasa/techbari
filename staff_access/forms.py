...
EXTRA_PERMISSION_GROUPS = (
    ...
    ("income_expense", "Income & Expense", ("view_income_expense", "manage_income_expense")),
    ("expenses", "Expense Workflow (Advanced)", ("view_expenses", "manage_expenses", "approve_expenses")),
